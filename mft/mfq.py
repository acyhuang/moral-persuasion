...
def compute_mfq(prompt_name, values, refusal_count):
    ...
    MFQ_TOTAL = MFQ_HARM_AVG + MFQ_FAIRNESS_AVG + MFQ_INGROUP_AVG + MFQ_AUTHORITY_AVG + MFQ_PURITY_AVG
    return [prompt_name, MFQ_HARM_AVG, MFQ_FAIRNESS_AVG, MFQ_INGROUP_AVG, MFQ_AUTHORITY_AVG, MFQ_PURITY_AVG, MFQ_TOTAL, refusal_count]
